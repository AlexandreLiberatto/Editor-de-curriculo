...
document.addEventListener("DOMContentLoaded", function() {
    ...
    // Toggle do menu de ações mobile
    if (mobileActionButton) {
        mobileActionButton.addEventListener("click", function() {
            // Só funciona em dispositivos mobile (tela <= 768px)
            if (window.innerWidth <= 768) {
                mobileActionsMenu.classList.toggle("active");
                mobileActionButton.classList.toggle("active");
                
                const icon = mobileActionButton.querySelector("i");
                if (icon) {
                    if (mobileActionsMenu.classList.contains("active")) {
    ...
    // Fechar menu de ações ao clicar fora dele
    document.addEventListener("click", function(event) {
        // Só funciona em dispositivos mobile (tela <= 768px)
        if (window.innerWidth <= 768 && mobileActionButton && mobileActionsMenu && 
    ...
    window.addEventListener("resize", function() {
        if (window.innerWidth > 768) {
            ...
            // Fechar menu de ações mobile quando redimensionar para desktop
